<%-- 
    Document   : ordenar
    Created on : Dec 2, 2016, 11:11:52 AM
    Author     : james
--%>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <%
                ...
                String query = "select juego_lenguaje, count(juego_lenguaje) as juegos from juegos group by juego_lenguaje;";
                ResultSet rs = null;
            ...
            <tr>
                <%
                    String id = rs.getString("juego_lenguaje");
                    int name = rs.getInt("juegos");
            ...
            %>
                ...
                <!-- /.row -->
               <button type="submit" class="btn btn-default" name="registrar" href="ordenar.jsp">Ordenar por Lenguajes</button>
